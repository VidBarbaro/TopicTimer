...
VibrationPattern_4::~VibrationPattern_4()
{
...
void VibrationPattern_4::update()
{
    if (_patternStarted)
    {
...
void VibrationPattern_4::cancel()
{
    if (_patternStarted)
    {
...
bool VibrationPattern_4::isFinished()
{
