...
class ServerCallbacks : public NimBLEServerCallbacks
{
    ...
    {
        tft.drawString("Connected", 50, 40);
    ...
    {
        tft.drawString("Disconnected", 50, 40);
...
void setup()
{
    ...
    NimBLEService *pDeadService = pServer->createService(BLE_UUID_SERVICE);
