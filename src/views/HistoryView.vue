	...
	<div class="w-75 m-auto d-flex flex-column gap-4">
		<div class="mt-4 d-flex justify-content-end">
			<div class="w-25 d-flex gap-4">
				<select role='button' class="topicSelector text-white bg-tt-yellow shadow-none border-0 form-select">
					<option>
						Dummy item
					</option>
				</select>
		...
		<HistoryChart chartType="bar" :selectedWeekDay="date" :trackedData="jsonData"/>
	</div>
</template>
